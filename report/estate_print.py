...
report_sxw.report_sxw('report.inmobiliaria.estate.urbana.completo','estate','addons/inmobiliaria/report/estate_urbana_completo.rml',parser=estate,header=True)
